...
function draw_endgame()
	...
	print("\^w\^tsolved!", 38, 60)
	print("difficulty:", 26, 86)
	print(""..(difficulty), 102, 86)
	print("words found:", 26, 94)
	print(""..(exp), 102, 94)
	print("score: ", 26, 102)
	print(""..(4 * difficulty - 1 * exp), 102, 102)
	print("press ❎ for another!", 26, 115)
	pal()
end
-->8
--game lifecycle
...
function start_round()
	...
	local difficulty_min = difficulty
	local difficulty_max = difficulty + 3
	repeat
		my_word = rnd(all_nice_words)
		your_word = rnd(all_nice_words)
	until (
...
function reset_in_easy()

end

function init_menus()
	menuitem(1, "new game (easy)",
      function() difficulty = difficulty_easy; start_round(); end
    )
	menuitem(2, "new game (medium)",
      function() difficulty = difficulty_medium; start_round(); end
    )
	menuitem(3, "new game (hard)",
      function() difficulty = difficulty_hard; start_round(); end
    )
end
...
function _update()
	...
	if game_ended then
		if (btnp(❎)) do
			if (difficulty == difficulty_hard) difficulty = difficulty_hard
			if (difficulty == difficulty_medium) difficulty = difficulty_hard
			if (difficulty == difficulty_easy) difficulty = difficulty_medium
			start_round()
		end
		return
	end
